...
namespace IntegrityService
{
    ...
    {
        internal const string ServiceName = "FIM";
        private const string DisplayName = "FIM";
        ...
        private const string DefaultInstallFolderName = "FIM";
        ...
        {
            Console.WriteLine("IntegrityService self-installer");
            Console.WriteLine();
            Console.WriteLine("Usage:");
            Console.WriteLine("  IntegrityService.exe install [--install-dir <path>] [--start]");
            Console.WriteLine("  IntegrityService.exe uninstall [--install-dir <path>] [--remove-files]");
            Console.WriteLine();
