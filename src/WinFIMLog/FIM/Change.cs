...
namespace WinFIMLog.FIM
{
    public class Change : IChange
    {
        ...
        /// <summary>
        /// ACL evidence from the previously projected state, when available.
        /// </summary>
        public string PreviousACL { get; set; } = string.Empty;

        /// <summary>
        /// Consumer-facing confidence in the optional attribution.
        /// </summary>
        public string AttributionConfidence { get; set; } = "None";

        /// <summary>
        /// Technique used to obtain the optional identity evidence.
        /// </summary>
        public string AttributionMethod { get; set; } = "None";

        /// <summary>
        /// Machine-readable explanation when attribution is incomplete.
        /// </summary>
        public string? AttributionMissingReason { get; set; }

        /// <summary>
        /// Timestamp of the source event used for correlation.
        /// </summary>
        ...
        /// <summary>
        /// Case-insensitive database key used by the latest-state projection.
        /// </summary>
        /// <remarks>
        ...
        /// <summary>
        /// Kernel process sequence number; unlike PID, this identifies an instance.
        /// </summary>
        public ulong? ProcessSequenceNumber { get; set; }

        /// <summary>
        /// Canonical identity of the effective monitoring scope.
        /// </summary>
